...
export default function (): JSX.Element {
   ...
   return <div id="authentication-modal" tabIndex={-1} aria-hidden="true" className={`
      fixed top-0 left-0 right-0 
      z-50 w-full p-4 
      overflow-x-hidden overflow-y-auto 
      md:inset-0 h-modal
      h-full justify-center items-center hidden
      backdrop-blur
      duration-[3s] ease-in-out transform transition-all
   `} role="dialog">
